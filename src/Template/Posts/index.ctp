 ...
 */
?>
<?= $this->Html->link(__('Back'), ['controller' => 'Panel', 'action' => 'index'], ['class' => 'btn btn-primary mb-3'])?>
    <h3><?= __('Posts') ?></h3>
    <?= $this->Html->link(__('New Post'), ['action' => 'add'], ['class' => 'btn btn-success mb-3'])?>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    ...
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $post->id], ['class' => 'btn btn-warning']) ?>
